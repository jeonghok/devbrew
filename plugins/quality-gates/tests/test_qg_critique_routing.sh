...
ag '산출물.*비평.*모드' "critique routing described"
...
agf '/qg critique <path>' "Quick Reference documents /qg critique"
...
agf '자연어 의도는 모델이' "NL critique intent noted as model-owned"
