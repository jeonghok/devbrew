...
SCRIPT = Path(__file__).resolve().parents[1] / "scripts" / "check-shape-completeness.py"
REPO = Path(__file__).resolve().parents[3]        # repo root (plugins/plugin-audit/tests → parents[3])
