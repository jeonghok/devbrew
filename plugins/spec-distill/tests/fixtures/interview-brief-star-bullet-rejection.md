...
audit_file: interview-brief-star-bullet-rejection.audit.md
user_sourced_items:
  - id: C1
    source: verbatim
    status: confirmed
...
- 위험 — islands architecture 우선 도입 → https://jasonformat.com/islands-architecture/ — verdict: defended — ST1
