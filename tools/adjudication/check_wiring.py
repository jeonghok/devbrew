...
EXEMPT = {
    ...
    ("plugins/quality-gates/scripts/docreview_route.py", 445,
     "continue in _classify_items @ if it.get('_absorbed_into')"): _DR_ABSORBED_ALREADY,
    ("plugins/quality-gates/scripts/docreview_route.py", 450,
    ...
    ("plugins/quality-gates/scripts/docreview_route.py", 516,
    ...
    ("plugins/quality-gates/scripts/docreview_route.py", 532,
     "continue in _auto_decides @ if not fx0 or fx0.get('state') != 'escalated'"):
        _DR_ESCALATED_FIX_NOT_LIVE,
    ("plugins/quality-gates/scripts/docreview_route.py", 562,
     "continue in _auto_decides @ if not f0"): _DR_RERAISE_TARGET_GONE,
    ("plugins/quality-gates/scripts/docreview_route.py", 573,
    ...
    # 521). 가드 텍스트 자체는 그대로다.
    ("plugins/quality-gates/scripts/docreview_route.py", 627,
