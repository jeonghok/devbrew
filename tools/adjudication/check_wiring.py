...
EXEMPT = {
    ...
    # 늘렸다(가드 텍스트 · 사유 무변경).
    ("plugins/quality-gates/scripts/docreview_route.py", 384,
     "continue in _absorb_same_as @ if not live"): _DR_ABSORB_GROUP_DEAD,
    ("plugins/quality-gates/scripts/docreview_route.py", 403,
     "continue in _classify_items @ if it.get('_absorbed_into')"): _DR_ABSORBED_ALREADY,
    ("plugins/quality-gates/scripts/docreview_route.py", 408,
    ...
    ("plugins/quality-gates/scripts/docreview_route.py", 474,
    ...
    ("plugins/quality-gates/scripts/docreview_route.py", 490,
    ...
    ("plugins/quality-gates/scripts/docreview_route.py", 526,
    ...
    # 521). 가드 텍스트 자체는 그대로다.
    ("plugins/quality-gates/scripts/docreview_route.py", 578,
