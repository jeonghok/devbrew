...
EXEMPT = {
    ...
    ("plugins/quality-gates/scripts/docreview_route.py", 355,
    ...
    ("plugins/quality-gates/scripts/docreview_route.py", 379,
    ...
    ("plugins/quality-gates/scripts/docreview_route.py", 460,
     "continue in _auto_decides @ if not fx0 or fx0.get('state') != 'escalated'"):
        _DR_ESCALATED_FIX_NOT_LIVE,
    ("plugins/quality-gates/scripts/docreview_route.py", 485,
     "continue in _auto_decides @ if not f0"): _DR_RERAISE_TARGET_GONE,
    ("plugins/quality-gates/scripts/docreview_route.py", 496,
