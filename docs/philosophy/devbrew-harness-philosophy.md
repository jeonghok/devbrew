...
- [1. The Three Laws](#1-the-three-laws-hierarchical-law-n-overrides-law-n1-on-conflict)
  ...
  - [Law 2 — Writer and Reviewer Must Never Share a Pass](#law-2--writer-and-reviewer-must-never-share-a-pass)
  - [Law 3 — Every Cycle Must Leave the System Smarter](#law-3--every-cycle-must-leave-the-system-smarter)
- [2. Principles (organized under the Three Laws)](#2-principles-organized-under-the-three-laws)
  - [2.1 Under Law 1 — Clarity Before Code](#21-under-law-1--clarity-before-code)
  - [2.2 Under Law 2 — Writer/Reviewer Independence](#22-under-law-2--writerreviewer-independence)
  - [2.3 Under Law 3 — Compounding Memory](#23-under-law-3--compounding-memory)
  - [2.4 Cross-Cutting Commitments (serve all three Laws)](#24-cross-cutting-commitments-serve-all-three-laws)
- [3. Anti-Corollaries (formerly "Named Anti-Patterns")](#3-anti-corollaries--formerly-named-anti-patterns)
- [4. Primitives the Harness Must Provide](#4-primitives-the-harness-must-provide-the-shape-of-a-devbrew-plugin)
  - [4.0 Canonical Plugin Directory Structure](#40-canonical-plugin-directory-structure--serves-l1-l2-l3)
  - [4.1 Spec Authoring (P1, P2)](#41-spec-authoring-p1-p2--serves-l1)
  - [4.2 Plan Authoring (P1, P7, P12)](#42-plan-authoring-p1-p7-p12--serves-l1)
  - [4.3 Writer/Executor Agents (P3, P8)](#43-writerexecutor-agents-p3-p8--serves-l2)
  - [4.4 Reviewer Agents / Persona Library (P3, P10)](#44-reviewer-agents--persona-library-p3-p10--serves-l2)
  - [4.5 Verifier (P4)](#45-verifier-p4--serves-l2)
  - [4.6 Compounding Skill (Law 3, P10)](#46-compounding-skill-law-3-p10--serves-l3)
  - [4.7 Hook Layer (P13, P14, P16)](#47-hook-layer-p13-p14-p16--serves-l1-l2-l3)
  - [4.8 State File (P5, P14)](#48-state-file-p5-p14--serves-l3)
  - [4.9 Compose-Plugin Dispatch (P9)](#49-compose-plugin-dispatch-p9--serves-l1-l2-l3)
  - [4.10 Benchmark Suite (P16)](#410-benchmark-suite-p16--serves-l2)
- [5. Philosophical Stance on Genuine Tensions](#5-philosophical-stance-on-genuine-tensions)
  - [5.1 "도구를 배우지 마라" vs. "도구는 네 인터페이스다"](#51-도구를-배우지-마라-vs-도구는-네-인터페이스다)
  - [5.2 "멈추지 마라" vs. "사용자 확인을 위해 pause"](#52-멈추지-마라-vs-사용자-확인을-위해-pause)
  - [5.3 수치적 엄격함 vs. 구조적 엄격함](#53-수치적-엄격함-vs-구조적-엄격함)
  - [5.4 Role-scoped persona (gstack) vs. shared-pool agent (OMC)](#54-role-scoped-persona-gstack-vs-shared-pool-agent-omc)
  - [5.5 "Boil the Lake"](#55-boil-the-lake)
  - [5.6 "Zero hooks"](#56-zero-hooks)
- [6. Attribution Map (every idea → where it came from)](#6-attribution-map-every-idea--where-it-came-from)
- [7. What This Philosophy Is NOT](#7-what-this-philosophy-is-not)
- [8. Tagline & North-Star Candidates](#8-tagline--north-star-candidates)
- [9. Roadmap: Open Questions for Future Rounds](#9-roadmap-open-questions-for-future-rounds)
- [10. How This Doc Evolves](#10-how-this-doc-evolves)
- [11. Migration Table — 2026-05-06 Restructure](#11-migration-table--2026-05-06-restructure)
  - [11.1 Anti-Pattern Disposition (B.1)](#111-anti-pattern-disposition-b1)
  - [11.2 Principle Changes (B.2)](#112-principle-changes-b2)
  - [11.3 §4 Primitive Expansions](#113-4-primitive-expansions)
  - [11.4 Roadmap C# Disposition (53 Go candidates)](#114-roadmap-c-disposition-53-go-candidates)
- [Appendix A — Direct Quotes Preserved](#appendix-a--direct-quotes-preserved)
...
**P8 determinism-economy refinement added 2026-06-07** — 결정론 메커니즘의 양에도 P8을 적용하는 단락 흡수 (§5.6 "Zero hooks"의 일반화). 새 P# 없이 흡수 — lightness meta-principle (cf. R4 §4.6 흡수 선례). non-load-bearing 영역의 모델 신뢰는 Law 1·Law 2의 load-bearing 결정론과 충돌하지 않음. v2.6.0에서 self-honest verdict floor(정확성 한 점 결정론 + redirect/ routing 모델 신뢰)가 같은 단락의 대칭 사례로 흡수됨 — 새 P# 없음.
