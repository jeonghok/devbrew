...
- 기각 — 두 대칭 옹호자(원안 편·대안 편)로 builder 를 나누고 판정은 제3자가 하는 대안 → 사람 판정 보완(기계 어휘 부재로 defended 기록): 원안의 축은 유지하되 P0 명시·goal 리터럴·대안 케이스 선행 셋을 더한다. 두 옹호자 설계는 Khan 의 이득 조건(blind judge·교차 반박)이 R3 에 없고 동종 다중 토론이 오염을 늘린다는 근거가 사용자 불만의 핵심을 친다 — verdict: refined — ST1 (이관 2026-09-06)
