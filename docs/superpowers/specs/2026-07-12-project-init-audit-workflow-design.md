...
- **Date**: 2026-07-12
- **Revision**: r6 — 분리 리뷰 **5라운드(re-review cap 도달)**, 각 4 렌즈, 총 134 에이전트. 생존 추이 **9 → 4 → 2 → 1 → 1**. r1의 세 토대가 전부 반증돼 교체됐고, r2·r3가 *고치면서 만든* 회귀들이 정정됐으며, **r5·r6는 brief 자체의 "확정 사실" 4건 중 3건이 틀렸음을 밝히고 그 범주를 폐기했다.** §19 참조.
