...
- [2026-08-23-dispatch-lock-mutations](2026-08-23-dispatch-lock-mutations.md) — 2026-08-23 · dispatch 처분 락(6축 A①②③④·B·C) mutation M1~M18(+M8b) 전건 실행 기록. M8a/M8b 는 macOS bash 3.2 가 멀티바이트 문자 뒤 `set -u` 아래서 스크립트를 크래시시키는 셋째 결과(두 가설 모두 아님)를 냈다 — 락을 고칠 사유로 남김
